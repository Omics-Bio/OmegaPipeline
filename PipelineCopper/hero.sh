...
#SplitFolderMerged="/chongle/Xuan/Hero/Test/Split/empty/"
#SplitFolderUnmerged="/chongle/Xuan/Hero/Test/Split/unmerged/"
#Filename="Split"
#Target="/chongle/Xuan/Hero/Test/Split/unmerged/"
...
--suffix ${Filename}_${namenew} -c 0.15 --covinfo --covfilter 2 \
